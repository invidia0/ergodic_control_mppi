...
SWEEP_ARMS = (
    "baseline",
    "memory_off", "gain_30", "gain_120",
    "plan_off", "plan_3", "plan_10",
    "h_0.47", "h_2.35", "h_5.0",
    "tau_3", "tau_11",
    "balance_0.5",
    "release_off", "release_1.75", "release_3.0",
    "ceiling_0", "ceiling_0.5",
...
PROFILE_KEYS = {
    ...
    "alpha": ("mppi", "alpha"),
    "memory_time": ("reference", "memory_time"),
    "fine_bandwidth": ("reference", "fine_bandwidth"),
    "memory_gain": ("reference", "memory_gain"),
    "memory_balance": ("reference", "memory_balance"),
    "plan_gain": ("reference", "plan_gain"),
    "track_weight": ("reference", "weight_track"),
    "reference_speed": ("reference", "reference_speed"),
    "transit_speedup": ("reference", "transit_speedup"),
    "dwell_slowdown": ("reference", "dwell_slowdown"),
    "service_floor": ("reference", "service_floor"),
    "service_time": ("reference", "service_time"),
    "deficit_ceiling": ("reference", "deficit_ceiling"),
    "release_ratio": ("reference", "release_ratio"),
}
