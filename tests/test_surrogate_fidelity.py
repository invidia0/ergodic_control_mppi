"""Regressions for surrogate-vs-faithful reference-flow fidelity."""
...
from ergodic_control_mppi.experiments.surrogate_fidelity import (
    _spearman,
    faithful_reference_velocity,
    fidelity_walk,
    step_fidelity,
    summarize,
)
from ergodic_control_mppi.mppi.core import field_at, reference_velocity
...
class FaithfulFieldTest(unittest.TestCase):
    ...
    def test_each_rollout_is_queried_at_its_own_states(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            produced = faithful_reference_velocity(params, evaluation, carry.memory)
            expected = field_at(
    ...
    def test_it_differs_from_the_surrogate(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            faithful = faithful_reference_velocity(params, evaluation, carry.memory)
            surrogate = reference_velocity(params, evaluation, carry.memory)
